  ...
  return (
    ...
    >
      ...
      <motion.h1
        ...
        animate={{ y: 0 }}
        transition={{ delay: 0.1 }}
        className=" text-2xl rounded-sm font-extrabold px-2 pb-1 z-20 bg-yellow-400 "
      >
        Framer Motion{" "}
      </motion.h1>
      <motion.h1
        ...
        animate={{ y: 0 }}
        transition={{ delay: 0.1 }}
        className=" text-md rounded-sm text-black/50 mt-2 px-2 pb-1 z-20 bg-yellow-400 font-sans"
      >
        training camp
      </motion.h1>
    </motion.div>
